...
public class ResideMenu extends FrameLayout {
     ...
     * Set up the activity;
     *
     * @param activity Takes the activity to attach to
     */
     ...
     *
     * @param imageResource Image ID to set as Background
     */
     ...
     * Add a single items;
     *
     * @param menuItem  Add item to menu
     * @param direction where to add item (left or right menu)
     */
     ...
     * @param targetScaleX Scale on X-axis
     * @param targetScaleY Scale on Y-axis
     * @return Return Animator Set
     */
     ...
     *
     * @param ev check if view is ignored
     * @return return true if ignored
     */
